...
window.addEventListener('load', function () {
   ...
   form.addEventListener('submit', function (event) {
       ...
       document.getElementById('launchStatus')
           .innerText = 'Awaiting Information Before Launch';
       document.getElementById('launchStatus')
           .style.color = 'black';
       document.getElementById('pilotStatus')
           .innerText = `Pilot ${pilotNameInput.value} is ready for launch`;
       document.getElementById('copilotStatus')
           .innerText = `Co-Pilot ${coPilotNameInput.value} is ready for launch`;
       document.getElementById('fuelStatus')
           .innerText = 'Fuel Level high enough for launch';
       document.getElementById('cargoStatus')
           .innerText = 'Cargo Mass low enough for launch';
       ...
       if (!pilotNameInput.value.trim() || !coPilotNameInput.value.trim() || !fuelLevelInput.value.trim() || !cargoMassInput.value.trim()) {
       ...
       } else if (typeof String(pilotNameInput.value) !== 'string' || pilotNameInput.value.trim()
           .length === 0) {
           ...
           document.getElementById('faultyItems')
               .style.visibility = 'hidden';
       } else if (!isNaN(Number(pilotNameInput.value)) && pilotNameInput.value.trim()
           .length > 0) {
           ...
           document.getElementById('faultyItems')
               .style.visibility = 'hidden';
       } else if (typeof String(coPilotNameInput.value) !== 'string' || coPilotNameInput.value.trim()
           .length === 0) {
           ...
           document.getElementById('faultyItems')
               .style.visibility = 'hidden';
       } else if (!isNaN(Number(coPilotNameInput.value)) && coPilotNameInput.value.trim()
           .length > 0) {
       ...
       if (Number(fuelLevelInput.value) < 10000 && userInput) {
           ...
           document.getElementById('fuelStatus')
               .innerText = 'Fuel level too low for launch'
           document.getElementById('launchStatus')
               .innerText = 'Shuttle Not Ready for Launch';
           document.getElementById('launchStatus')
               .style.color = 'red';
           fuelReady = false;
           event.preventDefault();
       ...
       if (Number(cargoMassInput.value) > 10000 && userInput) {
           document.getElementById('faultyItems')
               .style.visibility = 'visible';
           document.getElementById('cargoStatus')
               .innerText = 'Cargo mass too high for launch'
           document.getElementById('launchStatus')
               .innerText = 'Shuttle Not Ready for Launch';
           document.getElementById('launchStatus')
               .style.color = 'red';
